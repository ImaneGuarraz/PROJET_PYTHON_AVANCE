...
def process_images(image1_path: str, logo_path: str, output_path: str):
    ...
    img1 = Image.open(image1_path)  # charge l'image principale locale
    ...
    pos_x = img1.width - logo.width - 20  # calcule la position horizontale du logo
    pos_y = img1.height - logo.height - 20  # calcule la position verticale du logo
    ...
    img1.save(output_path)  # enregistre l'image finale dans le fichier output_path
